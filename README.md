...
- 다중 스레드 대량 생성, 진행률 표시와 Enter 입력 중단
- 사다리타기
- 범위 지정 무작위 정수와 실수 생성
...
선택한 난수원과 이유를 표준 오류에 표시합니다. CLI와 메뉴는 생성 개수 64 bytes, 정수·실수·호스트 입력 4096 bytes, 사다리 입력 65536 bytes의 동일한 한도를 사용합니다. 메뉴의 줄바꿈 문자는 한도에 포함하지 않으며, 값 내부의 줄바꿈은 허용하지 않습니다.
