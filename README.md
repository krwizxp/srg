...
비 x86_64 플랫폼에서는 서버 시간 확인과 수동 입력 생성 중심으로 메뉴를 제공합니다.
x86_64 환경에서 CPU가 RDSEED/RDRAND를 제공하면 하드웨어 RNG 기능(메뉴 1~4)을 함께 사용할 수 있으며, 메뉴 5(서버 시간 확인)와 메뉴 7(수동 입력 생성)은 계속 사용할 수 있습니다.
## 출력 파일
